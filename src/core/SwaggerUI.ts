...
export class SwaggerUI {
    ...
    public static getRoute(): string {
        return process.env.APP_URL_PREFIX || '/api' + process.env.SWAGGER_ROUTE || '/docs';
    }
    ...
    public setup(app: express.Application): void {
        if (Environment.isTruthy(process.env.SWAGGER_ENABLED || 'true')) {
            ...
            const swaggerFile = require(path.join(basePath, process.env.SWAGGER_FILE || '/src/api/swagger.json'));
